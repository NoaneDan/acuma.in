...
use AcumaIn\Import\FacebookPhotoImport;


class ImportFacebookPhotoCommand extends Command {
    
    protected function configure() {
        
        $this
            ->setName('facebook:photoImport')
            ->setDescription('Import photos from Facebook')
            ->setHelp('This application imports photos from a Facebook event')
            ->addArgument('city', InputArgument::REQUIRED, 'The city from which to import event photos');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        $importer = new FacebookPhotoImport($city, $access_token->access_token);
        $importer->getPhotosFromAllEvents();
    }
